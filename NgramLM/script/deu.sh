...
echo 'Deutsch'
../KenLM/kenlm-master/build/bin/lmplz -o 3 -S 70% < ~/Documents/deu_news_2009_100K/nl_deu_news_2009_100K-sentences.txt > ../mydata/deu.arpa
python2 ../src/beets.py ../../data/evaluation_dir/evaluation_data_pre/ ../mydata/lm_news_result/lm_score/ ../mydata/deu.arpa
...
cp -R ../mydata/lm_news_result/lm_score ../mydata/deu/
cp -R ../mydata/lm_news_result/A_lm ../mydata/deu/
cp -R ../mydata/lm_news_result/B_lm ../mydata/deu/
